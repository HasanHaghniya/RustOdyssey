...
fn main() {
    ...
    for ticket in tickets {
        match ticket {
            Ticket::Backstage(name, price) => println!("Backstage ticket for {} and the price: {}", name, price),
            Ticket::Vip(name, price) => println!("Standard ticket for {} and the price: {}", name, price),
